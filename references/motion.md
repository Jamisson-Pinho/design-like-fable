...
- Quando considerar usar: página com 3+ seções sequenciais que formam uma jornada real (processo, trajeto, linha do tempo). Quando NÃO usar: seções sem relação sequencial — fio conectando conteúdo paralelo é decoração fingindo ser estrutura
